DROP TABLE IF EXISTS messages, chat_participants, chats, appeals, reports, sdq_results, feedback, articles, post_likes, seen_posts, saved_posts, connections, comments, posts, users CASCADE;
